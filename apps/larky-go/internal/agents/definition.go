...
// InitialPrompt, OmitLarkyMd, RequiredMcpServers) are still parsed so user definitions don't lose
...
type AgentDefinition struct {
	...
	// OmitLarkyMd drops the LARKY.md hierarchy from this agent's user context. Read-only agents
	// (Explore, Plan) save tokens by skipping it.
	OmitLarkyMd bool `yaml:"omitLarkyMd"`
