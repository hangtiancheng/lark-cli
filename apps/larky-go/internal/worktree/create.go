...
// WorktreesDir is where all Larky-managed worktrees live: a single directory inside the repo root
...
// <repoRoot>/.larky/worktrees/, or resumes it if it already exists.
//
