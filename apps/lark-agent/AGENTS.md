...
AI intelligent OnCall assistant, migrated from SuperBizAgent (Go + cloudwego/eino). Brand: lark-agent.
...
- plan-execute-replan follows mewcode's event-stream pattern (AsyncGenerator<Event>).
