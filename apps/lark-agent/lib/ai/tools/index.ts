// Wrap tools using Vercel AI SDK's tool(), following the pattern from ai-codegen server/src/ai/tools/file-tools.ts
// (ai-codegen uses LangChain tools; here we switch to AI SDK tools)
import { tool } from "ai";
import {
